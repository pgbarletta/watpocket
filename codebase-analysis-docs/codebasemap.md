...
- Python dev extra (`.[dev]`) provides release tooling dependencies (`build`, `twine`) used by wheel build/upload workflows in `scripts/pypi_release_wheels.sh` (source: `pyproject.toml`, `scripts/pypi_release_wheels.sh`).
