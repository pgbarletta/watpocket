...
inline Error error(const char *format, Args && ... arguments) {
    return Error(fmt::format(fmt::runtime(format), std::forward<Args>(arguments)...));
}

/// Create a `FileError` using the given `format` and `arguments`.
template <typename... Args>
inline FileError file_error(const char *format, Args && ... arguments) {
    return FileError(fmt::format(fmt::runtime(format), std::forward<Args>(arguments)...));
}
...
inline MemoryError memory_error(const char *format, Args && ... arguments) {
    return MemoryError(fmt::format(fmt::runtime(format), std::forward<Args>(arguments)...));
}
...
inline FormatError format_error(const char *format, Args && ... arguments) {
    return FormatError(fmt::format(fmt::runtime(format), std::forward<Args>(arguments)...));
}
...
inline SelectionError selection_error(const char *format, Args && ... arguments) {
    return SelectionError(fmt::format(fmt::runtime(format), std::forward<Args>(arguments)...));
}
...
inline OutOfBounds out_of_bounds(const char *format, Args && ... arguments) {
    return OutOfBounds(fmt::format(fmt::runtime(format), std::forward<Args>(arguments)...));
}
...
inline PropertyError property_error(const char *format, Args && ... arguments) {
    return PropertyError(fmt::format(fmt::runtime(format), std::forward<Args>(arguments)...));
}
